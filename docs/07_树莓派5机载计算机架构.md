...
> 本文档描述灵云01号飞艇机载计算机(Companion Computer)基于 **树莓派5 + Ubuntu Server 24.04 + ROS2 Jazzy** 的完整架构。
...
graph TB
    subgraph 机载计算机
        RPi5[树莓派5<br/>8GB RAM<br/>Ubuntu Server 24.04<br/>ROS2 Jazzy]
...
| 操作系统 | Ubuntu Server 24.04 LTS (64-bit) | 与 ROS2 Jazzy 官方匹配 |
...
机载计算机软件采用 **ROS2 Jazzy** 多包组织，源码位于 [src/](../src/) 目录。
...
- **生成日期**: 2026-07-20
- **机载计算机**: Raspberry Pi 5 (8GB) + Ubuntu Server 24.04 LTS
- **ROS2 版本**: Jazzy Jalisco (LTS)
- **MAVROS 版本**: ros-jazzy-mavros (最新)
