...
TEST(MpptProtocol, ParseRealtime)
{
  ...
  MpptData out;
  airship_mppt::parse_realtime(d.data(), out);
...
TEST(MpptProtocol, ParseRated)
{
  ...
  MpptData out;
  airship_mppt::parse_rated(d.data(), out);
...
TEST(MpptProtocol, ParseState)
{
  ...
  MpptData out;
  airship_mppt::parse_state(d.data(), out);
...
TEST(MpptProtocol, ParseEnergyDay)
{
  ...
  MpptData out;
  airship_mppt::parse_energy_day(d.data(), out);
...
TEST(MpptProtocol, ParseEnergyTotal)
{
  ...
  MpptData out;
  airship_mppt::parse_energy_total(d.data(), out);
...
TEST(MpptProtocol, ParseTemp)
{
  ...
  MpptData out;
  airship_mppt::parse_temp(d.data(), out);
...
TEST(MpptProtocol, ParseControl)
{
  ...
  MpptData out;
  airship_mppt::parse_control(d.data(), out);
